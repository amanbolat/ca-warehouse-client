// Code generated by "enumer -type=DeliveryMethod -json -sql -transform=snake"; DO NOT EDIT.
...
func (i TransportMethod) String() string {
	if i < 0 || i >= TransportMethod(len(_TransportMethodIndex)-1) {
		return fmt.Sprintf("DeliveryMethod(%d)", i)
	}
...
func TransportMethodString(s string) (TransportMethod, error) {
	...
	return 0, fmt.Errorf("%s does not belong to DeliveryMethod values", s)
}
...
// MarshalJSON implements the json.Marshaler interface for DeliveryMethod
func (i TransportMethod) MarshalJSON() ([]byte, error) {
	return json.Marshal(i.String())
}

// UnmarshalJSON implements the json.Unmarshaler interface for DeliveryMethod
func (i *TransportMethod) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return fmt.Errorf("DeliveryMethod should be a string, got %s", data)
	}
